...
<body>
  ...
  <div class="content">
          ...
          <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu dropdown-menu-dark">
                <li class="dropdown-preview"><a class="dropdown-item" href="{{ route('japan') }}">Visit Japan</a><div class="preview">Land of the Rising Sun 🌸</div></li>
                <li class="dropdown-preview"><a class="dropdown-item" href="{{ route('pakistan') }}">Pakistan</a><div class="preview">Land of Peaks and Valleys 🏔️</div></li>
                <li class="dropdown-preview"><a class="dropdown-item" href="{{ route('turkia') }}">Turkey</a><div class="preview">Where East Meets West 🕌</div></li>
                
                <li class="dropdown-preview"><a class="dropdown-item" href="{{ route('malysia') }}">Malaysia</a><div class="preview">Truly Asia 🌴</div></li>
              </ul>
            </li>
           ...
           <li class="nav-item"><a class="nav-link" href="{{ route('tourpkg') }}">packages</a></li>
    ...
    <div class="container text-center mt-5 pt-5">
      ...
      <a href="{{ route('login') }}" class="btn btn-warning btn-cta mt-3 shadow">Start Your Journey</a>
    </div>
  </div>
